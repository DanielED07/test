...
rm(list=ls())
archivos <- dir("./Mejorado/Actualizar 2022_1-2022_2")
load("./Mejorado/BD_trabajos.RData")

data1 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='Comité T.G 21-07-2022',skip = 2)
data2 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='Comité T.G 02-08-2022',skip = 2)
data3 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='Comité T.G 18-08-2022',skip = 2)
data4 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='Comité T.G 06-09-2022',skip = 2)
data5 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='Comité T.G 20-09-2022',skip = 2)
data6 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='comité T.G 04-10-2022',skip = 2)
data7 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='Comité T.G 15-11-2022',skip = 2)
data8 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[3]),sheet ='Comité T.G 29-11-2022',skip = 2)
...
idx_pos <- which(test$Nombre_Estudiante=='MODALIDAD CURSOS DE POSGRADOS')
test <- test[-idx_pos,]
#---------------------------------------------------------------------------
#---------------------------------------------------------------------------
#---------------------------------------------------------------------------
...
titulos_trabajos_segmentados_actualizar_3 <- rbind(titulos_trabajos_segmentados_actualizar,test)

save("titulos_trabajos_segmentados_actualizar_3", file = "./Mejorado/BD_Actualizar_3_20212.RData")
