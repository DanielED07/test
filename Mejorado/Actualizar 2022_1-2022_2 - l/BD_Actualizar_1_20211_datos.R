...
rm(list=ls())
archivos <- dir("./Mejorado/Actualizar 2022_1-2022_2 - l")
load("./Mejorado/BD_trabajos.RData")

data1 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[1]),sheet ='CTG-1',skip = 2)
data2 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[1]),sheet ='CTG-2',skip = 2)
data3 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[1]),sheet ='CTG-5',skip = 2)
data4 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[1]),sheet ='CTG-7',skip = 2)
data5 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[1]),sheet ='CTG-8',skip = 2)
data6 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[1]),sheet ='CTG-9',skip = 2)
data7 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[1]),sheet ='CTG-10E',skip = 2)
...
save("titulos_trabajos_segmentados_actualizar_1", file = "./Mejorado/BD_Actualizar_1_20211.RData")
