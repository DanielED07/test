...
data1 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-1',skip = 2)
data2 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-2',skip = 2)
data3 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-3',skip = 2)
data4 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-4',skip = 2)
data5 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-6',skip = 2)
data6 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-8',skip = 2)
data7 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-9',skip = 2)
data8 <- read_excel(paste0('./Mejorado/Actualizar 2022_1-2022_2/',archivos[2]),sheet ='CTG-10',skip = 2)
...
titulos_trabajos_segmentados_actualizar_2 <- rbind(titulos_trabajos_segmentados_actualizar,test)

save("titulos_trabajos_segmentados_actualizar_2", file = "./Mejorado/BD_Actualizar_2_20212.RData")
